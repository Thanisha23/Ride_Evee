...
const UpdateCustomer = () => {
    ...
    useEffect(() => {
        const fetchCustomer = async () => {
            try {
                const response = await axios.get(`http://localhost:3000/api/v1/customer/findCustomer/${customerId}`);
    ...
    const updateCustomer = async () => {
        try {
            const response = await axios.put(`http://localhost:3000/api/v1/customer/updateCustomer`, {
                id: customerId,
                ...customer
            }, {
